...
\include{0a-agradecimientos/agradecimientos}

%PFC/PFM/TESIS
\include{0b-resumen/resumen}
...
\include{0c-notacion/notacion} %No incluir si no se quiere, comentándolo
...
%
\include{01-introduccion/introduccion}%Introducción
%
\include{02-hardware/hardware.tex}
%
\include{03-placa/placa.tex}
%
\include{04-caja/caja.tex}
%
\include{05-arduino/arduino.tex}
%
\include{06-robotstudio/robotstudio.tex}
%
\include{07-resultados/resultados.tex}
%
\include{08-conclusiones/conclusiones.tex}
%
...
\include{09-guiadeuso/guiadeuso.tex}
%\include{10-anexos/anexo.tex}
