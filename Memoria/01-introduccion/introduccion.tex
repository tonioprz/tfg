...
Finalmente, en el \nameref{Anexo} se incluye una guía de uso que puede ser incluida dentro de un guión de prácticas para que los alumnos tengan todos los conocimientos necesarios para manejar el panel de control.
